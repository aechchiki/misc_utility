...
# verify that you removed all but forward/reverse
cat seen_once.sam | cut -f2 | sort | uniq -c
# should only display 0, 16 flags
...
# compare to ref
/home/aechchik/bin/cuffcompare -G seen_once_header_sort.gtf -r /scratch/beegfs/monthly/aechchik/isoforms/Drosophila_melanogaster.BDGP6.39.gtf
